			...
			<div id="dashboard-container">
				<div id="side-navbar-container">
					<ul id="side-navbar">
						...
						<a href="?action=logs"><li class="side-navbar-button"><span class="glyphicon glyphicon-th-list" style="margin-right: 10px;"></span><?= getLangString("logs") ?></li>
				...
				<select class="dropdown" id="dashboard-menu-dropdown">
					...
					<option class="dashboard-menu-dropdown-option" value="logs">Logs</option>
