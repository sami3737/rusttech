...
if ($user->IsAdmin())
{
    ...
    if(isset($_POST['editpackage'])){
        ...
        if(is_numeric($_POST['packageprice'])){
            if($_POST['packageprice'] > 99999999999 || $_POST['packageprice'] < 0.01){
                array_push($pageError, "Price can't be more than " . $currencycode . "99999999999 or less than " . $currencycode . "0.01.");
            } else {
                $priceValid = true;
            }
        } else {
